...
static int sum_vectorized_unrolled(int n, int *a) {
    ...
    for (int i = 0; i < n / 16 * 16; i += 16) {
        v1 = _mm_add_epi32(v1, _mm_loadu_si128((__m128i *)(a + i + 0)));
        v2 = _mm_add_epi32(v2, _mm_loadu_si128((__m128i *)(a + i + 4)));
        v3 = _mm_add_epi32(v3, _mm_loadu_si128((__m128i *)(a + i + 8)));
        v4 = _mm_add_epi32(v4, _mm_loadu_si128((__m128i *)(a + i + 12)));
    }
